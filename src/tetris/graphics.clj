...
(defn point-to-screen-rect [pt]
  "Converts a point to a rectangle on the screen (more specifically,
game panel). Returns (x y width height). Does not draw anything on the screen."
  (map #(* point-size %)
...
(defn dimmer-panel [#^Color color & comps]
  "Returns a panel that is generally transparent, but provides a 50%
translucency with the specified colors over components comps."
